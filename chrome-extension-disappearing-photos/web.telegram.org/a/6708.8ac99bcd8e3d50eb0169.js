    ...
    [6708], {
        5130: (e, t, s) => {
            ...
            class r {
                ...
                constructor(e, t, s) {
                    this.target = e, this.onUpdate = t, this.channel = s
                }
                destroy() {}
                init(...e) {
                ...
                request(e) {
                    ...
                    if ("function" == typeof o.args[o.args.length - 1]) {
                        o.withCallback = !0;
                        const e = o.args.pop();
                        h.callback = e, s.set(e, h)
                    }
                    return t.set(n, h), d.catch(() => {}).finally(() => {
                        t.delete(n), h.callback && s.delete(h.callback)
                    }), this.postMessageOnTickEnd(o, a), d
                }
                cancelCallback(e) {
                    e.isCanceled = !0;
                    const {
                ...
                onMessage(e) {
                    ...
                    e.channel === s && e.payloads.forEach(e => {
                ...
                postMessagesOnTickEnd = (0, a.Fe)(() => {
                    const {
                        channel: e
                    } = this, t = this.pendingPayloads, s = this.pendingTransferables;
            ...
            function n(e, t, s) {
                ...
                return e.addEventListener("message", a), i.destroy = () => {
        ...
        41074: (e, t, s) => {
            ...
            var i = s(31481),
                a = s(5130);
            const r = Math.min(navigator.hardwareConcurrency || 4, 4);
            let n;

            function o() {
                return i.W75 ? [] : (n || (n = new Array(r).fill(void 0).map(() => {
                    const e = new Worker(new URL(s.p + s.u(9443), s.b));
                    return {
                        worker: e,
                        connector: (0, a.U)(e, void 0, "media")
                    }
                })), n)
            }

            function h(e, t) {
                return o()[t].connector.request(e)
            }
        },
        66708: (e, t, s) => {
            s.d(t, {
            ...
            class x {
                ...
                direction = 1;
                static init(...e) {
                    const [, t, s, i, a = (0, o.A)(), , r] = e;
                    let n = f.get(s);
                    return n ? n.addView(a, t, r, i ? .coords) : (n = new x(...e), f.set(s, n)), n
                }
                constructor(e, t, s, i, a = (0, o.A)(), r, n, h, d) {
                    this.tgsUrl = e, this.container = t, this.renderId = s, this.params = i, this.customColor = r, this.onLoad = n, this.onEnded = h, this.onLoop = d, this.addView(a, t, n, i.coords), this.initConfig(), this.initRenderer()
                }
                removeView(e) {
                    const {
                        canvas: t,
                    ...
                    i ? s.clearRect(a.x, a.y, this.imgSize, this.imgSize) : t.remove(), this.views.delete(e), this.views.size || this.destroy()
                }
                isPlaying() {
                ...
                pause(e) {
                    this.lastRenderAt = void 0, (!e || (this.views.get(e).isPaused = !0, Array.from(this.views.values()).every(({
                        isPaused: e
                    }) => e))) && (this.isWaiting ? this.stopFrameIndex = this.approxFrameIndex : this.isAnimating = !1, this.params.isLowPriority || (this.frames = this.frames.map((e, t) => t === this.prevFrameIndex ? e : void(e && e !== c && e.close()))))
                }
                playSegment([e, t], s = !1, i) {
                    i && (this.views.get(i).isPaused = !1);
                    const a = Math.round(this.approxFrameIndex);
                    this.stopFrameIndex = Math.floor(t / this.reduceFactor), (a !== t || s) && (this.approxFrameIndex = Math.floor(e / this.reduceFactor)), this.direction = e < t ? 1 : -1, this.doPlay()
                }
                setSpeed(e) {
                    this.speed = e
                }
                ...
                async setSharedCanvasCoords(e, t) {
                    const s = this.views.get(e),
                        ...
                        r = !i.dataset.isJustCleaned || "false" === i.dataset.isJustCleaned;
                    r || await w.get(i);
                    let [n, o] = [i.width, i.height];
                    if (r) {
                        const e = this.calcSizeFactor();
                        [n, o] = v(i, e), a.clearRect(0, 0, n, o), i.dataset.isJustCleaned = "true", (0, d.YS)(() => {
                    ...
                    h && h !== c && a.drawImage(h, s.coords.x, s.coords.y)
                }
                addView(e, t, s, i) {
                    const a = this.calcSizeFactor();
                    let r;
                    if (t instanceof HTMLDivElement) {
                        ...
                        r = Math.round(i * a), this.imgSize || (this.imgSize = r, this.imageData = new ImageData(r, r)), (0, d.RK)(() => {
                            const a = document.createElement("canvas"),
                                n = a.getContext("2d");
                            a.classList.add("rlottie-canvas"), a.style.width = `${i}px`, a.style.height = `${i}px`, a.width = r, a.height = r, t.appendChild(a), this.views.set(e, {
                                canvas: a,
                                ctx: n,
                                onLoad: s
                            })
                        ...
                        const n = t,
                            o = n.getContext("2d");
                        r = Math.round(this.params.size * a), this.imgSize || (this.imgSize = r, this.imageData = new ImageData(r, r));
                        const [h, d] = v(n, a);
                        this.views.set(e, {
                            canvas: n,
                            ctx: o,
                ...
                calcSizeFactor() {
                    const {
                        size: e,
                        isLowPriority: t,
                        quality: s = (t && (!e || e > p) ? l : m)
                    } = this.params;
                    return Math.max(window.devicePixelRatio * s, 1)
                }
                destroy() {
                    this.isDestroyed = !0, this.pause(), this.clearCache(), this.destroyRenderer(), f.delete(this.renderId)
                }
                clearCache() {
                ...
                changeData(e) {
                    this.pause(), this.tgsUrl = e, this.initConfig(), u[this.workerIndex].request({
                ...
                doPlay() {
                    this.framesCount && (this.isDestroyed || this.isAnimating || (this.isWaiting || (this.lastRenderAt = void 0), this.isEnded = !1, this.isAnimating = !0, this.isWaiting = !1, (0, i.i0)(() => {
                        ...
                        if (!this.isAnimating && Array.from(this.views.values()).every(({
                                isLoaded: e
                            }) => e)) return !1;
                        const e = Math.round(this.approxFrameIndex),
                            t = this.getFrame(e);
                        if (!t || t === c) return t || this.requestFrame(e), this.isAnimating = !1, this.isWaiting = !0, !1;
                        this.cacheModulo && e % this.cacheModulo === 0 && this.cleanupPrevFrame(e), e !== this.prevFrameIndex && (this.views.forEach(e => {
                            ...
                            i && a || (s.clearRect(r || 0, n || 0, this.imgSize, this.imgSize), s.drawImage(t, r || 0, n || 0)), i || (e.isLoaded = !0, o ? .())
                        }), this.prevFrameIndex = e);
                        const s = Date.now(),
                            i = this.lastRenderAt ? this.msPerFrame / (s - this.lastRenderAt) : 1,
                            a = this.direction * this.speed / i,
                            r = Math.round(this.approxFrameIndex + a);
                        if (this.lastRenderAt = s, a > 0 && (e === this.framesCount - 1 || r > this.framesCount - 1)) {
                            ...
                            if (void 0 !== this.stopFrameIndex && (e === this.stopFrameIndex || a > 0 && r > this.stopFrameIndex || a < 0 && r < this.stopFrameIndex)) return this.stopFrameIndex = void 0, this.isAnimating = !1, !1;
                            this.approxFrameIndex += a
                        }
                ...
                requestFrame(e) {
                    this.frames[e] = c, u[this.workerIndex].request({
...
//# sourceMappingURL=6708.8ac99bcd8e3d50eb0169.js.map